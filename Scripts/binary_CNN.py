...
# -*- coding: utf-8 -*-
"""Image Processing and Binary Classification.ipynb
...
Original file is located at
    ...
    MAKE SURE YOU HAVE A FOLDER OF THE UNZIPPED BINARY CLASSIFICATION DATA BEFORE YOU DO THIS!!!
"""
...
def test_model(model, criterion):
    ...
    print("F-Score is:", f1_score(all_labels, all_predictions))
...
torch.save(model_resnet18.state_dict(), "best_resnet18.pt")
...
torch.save(model_googlenet.state_dict(), "best_googlenet.pt")
...
model_vgg11.classifier[6] = nn.Linear(num_ftrs, 2).cuda()

model_vgg11, criterion = train_and_return_model(model_vgg11, False)

torch.save(model_vgg11.state_dict(), "best_vggnet.pt")
