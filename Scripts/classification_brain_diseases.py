...
# -*- coding: utf-8 -*-
"""Image Processing and Classification Brain Diseases.ipynb
...
all_samples = list()
process_dataset('./AlzheimersDataSet/NonDemented/*', 3200, 0, all_samples)
process_dataset('./AlzheimersDataSet/VeryMildDemented/*', 2240, 1, all_samples)
process_dataset('./AlzheimersDataSet/MildDemented/*', 896, 2, all_samples)
process_dataset('./AlzheimersDataSet/ModerateDemented/*', 64, 3, all_samples)
